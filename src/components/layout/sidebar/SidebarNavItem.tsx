...
const SidebarNavItem: React.FC<SidebarNavItemProps> = ({ 
  ...
  // Return different versions based on expanded state for proper tooltip behavior
  return (
    <NavLink
      to={to}
      className={cn(
        ...
        <TooltipProvider>
          <Tooltip delayDuration={300}>
            ...
            <TooltipContent 
              ...
              className="bg-white/90 backdrop-blur-sm text-[#3a7a89] border-none shadow-lg"
            >
              {label}
            </TooltipContent>
          </Tooltip>
